  ...
  return (
    ...
    >
      ...
      <section className="info-block">
        ...
        <p>
          Способ доставки обсуждаем <strong>после оплаты</strong> в переписке. Доступны несколько способов
          доставки. Подробнее — в разделе <Link to="/delivery">Доставка</Link>.
        </p>
        <p>
